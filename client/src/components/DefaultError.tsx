    ...
    return (
        <div className="relative flex min-h-dvh items-center bg-[#050505] text-(--bone)">
            ...
            <main className="relative mx-auto w-full max-w-2xl px-8 py-20 sm:px-12">
                ...
                <div className="animate-fade-up animation-duration-700 mb-16 flex items-center gap-4 [animation-delay:100ms]">
                ...
                <div className="animate-fade-up animation-duration-800 [animation-delay:200ms]">
                    ...
                    <h1 className="display-italic mt-3 text-[clamp(2.6rem,6vw,4rem)] leading-[0.95] tracking-[-0.02em] text-(--bone)">
                        The ledger
                        <br />
                        skipped a line.
                    </h1>
                ...
                {/* Actions */}
                <div className="animate-fade-up animation-duration-800 mt-10 flex flex-col gap-3 [animation-delay:400ms] sm:flex-row">
                    <button
                        type="button"
                        onClick={retry}
                ...
                <div className="animate-fade-up animation-duration-700 mt-16 flex items-center justify-between border-t border-(--hairline) pt-5 [animation-delay:600ms]">
