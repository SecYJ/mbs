...
const roomTracks = [
    {
        id: "AUR",
        label: "Aurora",
        accentClassName: "bg-(--room-aurora)",
...
export const AppPending = () => {
    return (
        ...
        >
            <div className="pending-grid-backdrop absolute inset-0 opacity-70" />
                    ...
                    <div className="divide-y divide-(--hairline)">
                        {roomTracks.map((room) => (
                            <div
                                key={room.id}
                                className={cn(
                                    "animate-fade-up animation-duration-620 grid min-h-16 grid-cols-[3.75rem_1fr] sm:grid-cols-[5.5rem_1fr]",
                                    room.delayClassName,
                                )}
                            >
                                <div className="grid justify-items-center border-r border-(--hairline) px-3 sm:px-4">
