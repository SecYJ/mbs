        ...
        <div className="space-y-3">
            ...
            <div className="relative">
                ...
                <button
                    ...
                    className="absolute top-1/2 right-0 flex size-9 -translate-y-1/2 cursor-pointer items-center justify-center text-(--bone-dim) transition-colors hover:text-(--gold)"
                >
                    {show ? (
