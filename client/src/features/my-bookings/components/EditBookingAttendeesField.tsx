        ...
        <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 border-b border-(--hairline) text-(--bone-muted) focus-within:border-(--gold)">
                ...
                <Input
                    ...
                    className="h-10 rounded-none border-0 bg-transparent px-0 text-[0.85rem] text-(--bone) shadow-none placeholder:text-(--bone-faint) focus-visible:ring-0"
                />
            </div>

            <div className="max-h-40 scrollbar-thin overflow-y-auto border border-(--hairline) bg-(--surface-02)">
                {matches.length === 0 ? (
                    ...
                    matches.map((user) => {
                        ...
                        return (
                            <button
                                ...
                                className="flex w-full items-center justify-between gap-3 border-b border-(--hairline) px-3 py-2 text-left transition-colors last:border-b-0 hover:bg-(--surface-01)"
                            >
