        ...
        <>
            ...
            <div className="flex items-center gap-3 border-t border-(--hairline) px-8 py-5">
                <button
                    ...
                    className="cursor-pointer px-3 py-2 text-[0.66rem] font-semibold tracking-[0.28em] text-(--bone-dim) uppercase transition-colors hover:text-(--bone) disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:text-(--bone-dim)"
                >
                    Reset
                </button>
                <button
                    ...
                    className="group flex flex-1 cursor-pointer items-center justify-center gap-2 border border-(--bone) bg-(--bone) py-2.5 text-[0.66rem] font-semibold tracking-[0.28em] text-black uppercase transition-all hover:bg-white hover:tracking-[0.32em]"
                >
                    confirm
                </button>
            </div>
...
const BookingFilterGroup = ({ label, children }: { label: string; children: ReactNode }) => (
