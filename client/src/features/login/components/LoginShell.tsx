    ...
    return (
        <div className="relative flex min-h-dvh bg-[#050505] text-(--bone)">
            ...
            <aside className="relative hidden overflow-hidden bg-[#050505] lg:flex lg:w-[58%]">
                <div
                    aria-hidden
                    className="hairline-draw-in pointer-events-none absolute top-0 right-24 bottom-0 w-px bg-(--hairline) [animation-delay:300ms]"
                />
                ...
                <div className="animate-fade-up animation-duration-700 absolute top-14 left-14 flex items-start gap-3 [animation-delay:100ms]">
                    ...
                    <span className="eyebrow mt-1 text-(--gold)">Suite · Meridian</span>
                </div>

                <div className="animate-fade-up animation-duration-700 absolute top-14 right-32 flex items-center gap-3 [animation-delay:200ms]">
                ...
                <div className="animate-fade-up animation-duration-700 absolute right-32 bottom-14 flex items-center gap-3 [animation-delay:900ms]">
