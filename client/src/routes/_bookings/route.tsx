                    ...
                    <div className="flex items-center gap-12">
                        <Link to="/bookings" className="flex items-center gap-3 no-underline">
                            ...
                            <div className="hidden flex-col leading-tight sm:flex">
                                <span className="text-[0.7rem] font-semibold tracking-[0.24em] text-(--bone) uppercase">
                                    Meridian
                                </span>
                        ...
                        <div className="hidden items-center gap-8 sm:flex">
                            {navItems.map((item) => (
                                ...
                                >
                                    {item.label}
                                    <span className="absolute right-0 bottom-0 left-0 h-px bg-transparent transition-all duration-300 group-data-[status=active]:bg-(--gold)" />
                                </Link>
                            ))}
                        </div>
                    </div>
