...
export const AdminHeader = ({ title, children }: AdminHeaderProps) => {
    return (
        <header className="sticky top-0 z-20 grid h-14 grid-cols-[1fr_auto_1fr] items-center gap-4 border-b border-(--a-border-hover) px-6 backdrop-blur-sm bg-[#0F1117E0]">
            <div />
