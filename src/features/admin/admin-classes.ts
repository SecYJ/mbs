...
export const adminSelectClasses =
    "h-9 cursor-pointer appearance-none rounded-lg border border-(--a-border-hover) bg-(--a-bg) bg-[url(data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%2712%27%20height=%2712%27%20viewBox=%270%200%2024%2024%27%20fill=%27none%27%20stroke=%27%23959db6%27%20stroke-width=%272%27%20stroke-linecap=%27round%27%20stroke-linejoin=%27round%27%3E%3Cpolyline%20points=%276%209%2012%2015%2018%209%27%3E%3C/polyline%3E%3C/svg%3E)] bg-[position:right_0.5rem_center] bg-no-repeat py-0 pr-8 pl-3 font-[inherit] text-[0.8125rem] text-(--a-text) outline-none transition-[border-color,box-shadow] duration-150 focus:border-(--a-accent-border) focus:shadow-[0_0_0_3px_var(--a-accent-subtle)]";
