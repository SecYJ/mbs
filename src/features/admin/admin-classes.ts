...
export const adminSelectClasses =
    "h-9 cursor-pointer appearance-none rounded-lg border border-(--a-border-hover) bg-(--a-bg) bg-[url(\"data:image/svg+xml,%3Csvg_xmlns='http://www.w3.org/2000/svg'_width='12'_height='12'_viewBox='0_0_24_24'_fill='none'_stroke='%23959db6'_stroke-width='2'_stroke-linecap='round'_stroke-linejoin='round'%3E%3Cpolyline_points='6_9_12_15_18_9'%3E%3C/polyline%3E%3C/svg%3E\")] bg-[position:right_0.5rem_center] bg-no-repeat py-0 pr-8 pl-3 font-[inherit] text-[0.8125rem] text-(--a-text) outline-none transition-[border-color,box-shadow] duration-150 focus:border-(--a-accent-border) focus:shadow-[0_0_0_3px_var(--a-accent-subtle)]";
