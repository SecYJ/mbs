...
export function RoomsPage() {
    ...
    const toggleActive = (id: string) => {
        ...
        toast(`${room?.name} ${room?.active ? "disabled" : "enabled"}`, room?.active ? "info" : "success");
    };
                                ...
                                {filtered.map((room) => {
                                    ...
                                    return (
                                        <RoomRow
                                            ...
                                            onToggleExpand={() => setExpandedId(isExpanded ? null : room.id)}
                        ...
                        <div className="admin-expand-row px-6 py-5">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    <div>
                                        <label
                                            className="mb-1.5 block text-[0.6875rem] font-semibold uppercase tracking-wider"
                                            style={{ color: "var(--a-text-muted)" }}
                                        >
                                            Room Name
                                        </label>
                                        <input className="admin-input w-full" defaultValue={room.name} />
                                    </div>
                                    <div>
                                        <label
                                            className="mb-1.5 block text-[0.6875rem] font-semibold uppercase tracking-wider"
                                        ...
                                        <input className="admin-input w-full" defaultValue={room.location} />
                                    </div>
                                    <div>
                                        <label
                                            className="mb-1.5 block text-[0.6875rem] font-semibold uppercase tracking-wider"
