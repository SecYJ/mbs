        ...
        <div>
            ...
            <div className="p-6">
                <div className="max-w-xl space-y-4">
                    ...
                    <div className="admin-rule-card">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                >
                                    How long a single booking can last. Users won't be able to create bookings longer
                                    than this.
                                </p>
                                ...
                                <div className="mt-4 flex items-center gap-3">
                                    <div className="relative">
                                        <input
                                            ...
                                            value={maxDuration}
                                            onChange={(e) =>
                                                setMaxDuration(Math.max(1, Math.min(24, Number(e.target.value))))
                                            }
                                            className="admin-input tabular-nums w-20 text-center pr-0"
                                        />
                                    </div>
                                    <span className="text-sm font-medium" style={{ color: "var(--a-text-secondary)" }}>
                                        hours
                                    </span>
                                ...
                                <div className="mt-3">
                                    ...
                                    />
                                    <div
                                        className="mt-1 flex justify-between text-[0.625rem] tabular-nums"
                    ...
                    <div className="admin-rule-card flex items-center gap-4" style={{ opacity: 0.4 }}>
                        <div
                            className="flex size-9 shrink-0 items-center justify-center rounded-lg"
                            style={{
                        ...
                        <div>
                            <h3 className="text-sm font-semibold" style={{ color: "var(--a-text-secondary)" }}>
                                More rules coming soon
                            </h3>
                            <p className="mt-0.5 text-[0.8125rem]" style={{ color: "var(--a-text-muted)" }}>
