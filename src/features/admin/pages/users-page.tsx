...
const initialUsers: User[] = [
	{ id: "1", name: "Alice Chen", email: "alice@company.com", role: "admin", active: true, lastLogin: "2 hours ago", avatarColor: "#e4a441" },
	{ id: "2", name: "Bob Wang", email: "bob@company.com", role: "user", active: true, lastLogin: "1 day ago", avatarColor: "#539bf5" },
	{ id: "3", name: "Carol Liu", email: "carol@company.com", role: "user", active: false, lastLogin: "30 days ago", avatarColor: "#34d399" },
	{ id: "4", name: "David Zhang", email: "david@company.com", role: "admin", active: true, lastLogin: "5 min ago", avatarColor: "#c084fc" },
	{ id: "5", name: "Eve Huang", email: "eve@company.com", role: "user", active: true, lastLogin: "3 hours ago", avatarColor: "#f97066" },
	{ id: "6", name: "Frank Li", email: "frank@company.com", role: "user", active: true, lastLogin: "6 hours ago", avatarColor: "#2dd4bf" },
];
...
export function UsersPage() {
	...
	const handleConfirm = () => {
		...
		if (type === "reset") {
			...
			toast(
				`${user.name} is now ${user.role === "admin" ? "a regular user" : "an admin"}`,
				"success",
			);
			...
			toast(
				`${user.name}'s account ${user.active ? "disabled" : "enabled"}`,
