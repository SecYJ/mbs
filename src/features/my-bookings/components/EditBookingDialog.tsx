...
export const EditBookingDialog = () => {
    ...
    return (
        ...
        >
            {isEditing ? (
                <DialogContent className="scrollbar-thin max-h-[calc(100dvh-4rem)] w-full overflow-y-auto rounded-none border border-(--hairline) bg-(--surface-01) text-(--bone) shadow-[0_40px_80px_rgba(0,0,0,0.6)] sm:max-w-lg">
                    <Suspense
                        fallback={
